...
- Revise Sentence Pairs
    ...
    - **Scenario**:<br/>
                1. The User chooses to revise.<br>
                2. The User is prompted to choose a number of sentence pairs to revise.<br>
                3. The User is presented with semi-random sentence pairs.<br>
                4. FOREACH, the User first sees the Dutch sentence and then can choose to reveal English when they are ready.<br>
                5. The User chooses to go to the next sentence pair when they have determined that they have adequately covered previous one.<br>
...
## Domain Model
**Description**: This diagram will show the different domains within the software and how they interact. In this case the python application, gui and database. 
